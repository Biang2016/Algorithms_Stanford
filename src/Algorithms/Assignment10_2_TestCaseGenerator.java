 ...
 */
public class Assignment10_2_TestCaseGenerator extends AbstractTestCaseGenerator {
    public Assignment10_2_TestCaseGenerator(String methodToUse, String solverClassName, String[] args) {
    ...
    public static void main(String[] args) {
        AbstractTestCaseGenerator.main(Assignment10_2_TestCaseGenerator.class, args);
        Assignment10_2_TestCaseGenerator tcg =
                new Assignment10_2_TestCaseGenerator(args[0], args[1], Arrays.copyOfRange(args, 2, args.length));
